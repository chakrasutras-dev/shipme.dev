...
Welcome to DevFlow! This guide will help you get the application running in minutes.
...
- Check [devflow.txt](../devflow.txt) for project specifications
